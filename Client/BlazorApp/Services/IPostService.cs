...
public interface IPostService
{
    ...
    public Task <ActionResult<GetPostResponseDto>> ReplacePostAsync (DeleteRequestDto request, string? title, string? body);
    public Task<IResult> DeletePostAsync(DeleteRequestDto request);
